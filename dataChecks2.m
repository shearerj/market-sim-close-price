function dataChecks2(file,expName)
% dataCheck2(file)
%
% This function takes a csv file, runs data checks on it and returns a results file. It checks for matching header number and column
% number, latency range, matching surplus, matching transaction numbers, matching execution speed, mathcing spread at med nbbo, 
% and matching volatility
%
...
fname = [expName, 'DataCheckResult.txt'];
...
fprintf(fileID, 'Test number of column headers equals equal max columns in data: ');
if headerNum == datac
