...
/**
 * Interface the represents a distribution that can be sampled from. The source
 * of randomness is independent of the distribution. This distribution just
 * contains the knowledge necessary to produce a sample.
 */
