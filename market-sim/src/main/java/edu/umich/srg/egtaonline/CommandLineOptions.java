...
public class CommandLineOptions {
	...
	@Option(name = { "-o", "--obs" }, description = "Path to observaton file location. (default: stdout)")
	...
	@Option(name = { "--egta" }, description = "Flag that this is running on egta. Disables logging among other things. (default: false)")
	public boolean egta = false;

	@Arguments(title = { "numobs" }, arity = 1, description = "The number of observations to gather from the simulation spec. If multiple simulation specs are passed in, this many observations will be sampled for each. (default: 1)")
	public int numObs = 1;
