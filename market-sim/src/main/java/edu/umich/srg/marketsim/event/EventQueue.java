...
/**
 * EventQueue holds the ordering of activities. Scheduled activities that occur
 * at the same time are randomly ordered, with the constraint that activities
 * scheduled at the future time, and between pops happen in the same order they
 * were scheduled in. If the sequence of scheduled activities were queued
 * "pop A pop B C pop" then they could happen in order "A B C", "B A C", or
 * "B C A".
 */
