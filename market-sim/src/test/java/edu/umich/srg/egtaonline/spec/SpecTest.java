...
public class SpecTest {
	...
	public void parseBuilderTest() {
		Spec props = Spec.builder("edu.umich.srg.egtaonline.spec.SpecTest$")
				.put("LongKey", "5")
				.put("EnumKey", "C")
				.build();
	...
	public void parseBuilderCaseFormatTest() {
		Spec props = Spec.builder("edu.umich.srg.egtaonline.spec.SpecTest$", CaseFormat.LOWER_UNDERSCORE)
				.put("long_key", "5")
				.put("enum_key", "C")
				.build();
	...
	public void parseTestPairs() {
		Spec props = Spec.fromPairs(
				"edu.umich.srg.egtaonline.spec.SpecTest$LongKey", "5",
