...
public class CallMarketTest {
  ...
  public void normalPricingPolicyTest() {
    ...
    assertQuote(quoteInfo.getQuote(), null, null);
  ...
  public void clearActivityInsertion() {
    ...
    assertQuote(quoteInfo.getQuote(), ABSENT, ABSENT);
    ...
    assertQuote(quoteInfo.getQuote(), 100, 110);
    ...
    assertQuote(quoteInfo.getQuote(), 100, ABSENT);
    ...
    assertQuote(quoteInfo.getQuote(), 100, 125);
  }
