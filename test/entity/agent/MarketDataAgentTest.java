...
public class MarketDataAgentTest {
	...
	public void setupTest() {
		...
		sip = new SIP(new TimeStamp(0));
		market = new MockMarket(sip);
	}

	@Test
	public void nyseSimpleTest() {
		MarketDataAgent agent = new MarketDataAgent(fundamental, sip, 
				market, rand, "test_files/nyseSimpleTest.csv");
		...
		OrderDatum correctOrderDatum = new OrderDatum('A', "0", "1", 'P', "SRG1",
				new TimeStamp(88), 'O', "AARCA", new Price(3249052), 5742346, BUY);
	...
	public void nyseTest() {
		...
		OrderDatum correct3 = new OrderDatum('A', "0", "10", 'B', "SRG4",
				new TimeStamp(192), 'O', "AARCA", new Price(5223572), 3921581, SELL);
