...
public class MarketMakerTest {
	...
	@Test
	public void submitOrderLadderBasicTest() {
		MarketMaker mm = new MockMarketMaker(exec, fundamental, sip, market, EntityProperties.fromPairs(
				Keys.NUM_RUNGS, 3,
				Keys.RUNG_SIZE, 5,
				Keys.TRUNCATE_LADDER, false,
				Keys.FIX, false));	// fix doesn't matter here, since not CDA market
		mm.stepSize = 5;
	...
	/**
	 * Test with FIX explicitly set to false
	 */
	@Test
	public void submitOrderLadderFixFalse() {
		...
		// Order at $30 (outer buy rung) should transact first
	...
	@Test
	public void submitOrderLadderFixTrue() {
		Market cda = new CDAMarket(exec, sip, new Random(), EntityProperties.empty()); 
		MarketMaker mm = new MockMarketMaker(exec, fundamental, sip, cda, EntityProperties.fromPairs(
				Keys.NUM_RUNGS, 3,
				Keys.RUNG_SIZE, 5,
