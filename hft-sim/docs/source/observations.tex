...
\verb|trans_rmsd|   & root mean square deviation (RMSD) between transaction prices and the value of the fundamental at time of execution (ignores NaNs) \\
\verb|trans_freq_X_rmsd|  & RMSD based on prices sampled every X timesteps (ignores NaNs) \\
